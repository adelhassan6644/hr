class DirectManager {
  ...
  factory DirectManager.fromJson(Map<String, dynamic> json) => DirectManager(
        ...
        directManager: json["direct_manager"] == null
            ? null
            : UserModel.fromJson(json["direct_manager"]),
        country:
            json["country"] == null ? null : Country.fromJson(json["country"]),
        national: json["national"] == null
            ? null
            : Country.fromJson(json["national"]),
        jobRole:
            json["job_role"] == null ? null : Job.fromJson(json["job_role"]),
        jobType:
            json["job_type"] == null ? null : Job.fromJson(json["job_type"]),
        jobCategory: json["job_category"] == null
            ? null
            : Job.fromJson(json["job_category"]),
        jobUnit:
            json["job_unit"] == null ? null : Job.fromJson(json["job_unit"]),
        jobLevel:
            json["job_level"] == null ? null : Job.fromJson(json["job_level"]),
        branch: json["branch"] == null ? null : Branch.fromJson(json["branch"]),
        hrEmployee: json["hr_employee"],
        employeeRecompenses: json["employee_recompenses"] == null
            ? []
            : List<dynamic>.from(json["employee_recompenses"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "employee_recompenses": employeeRecompenses == null
            ? []
            : List<dynamic>.from(employeeRecompenses!.map((x) => x)),
...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
        ...
        directManager: json["direct_manager"] == null
            ? null
            : DirectManager.fromJson(json["direct_manager"]),
        country:
            json["country"] == null ? null : Country.fromJson(json["country"]),
        national: json["national"] == null
            ? null
        ...
        employeeRecompenses: json["employee_recompenses"] == null
            ? []
            : List<EmployeeRecompense>.from(json["employee_recompenses"]!
                .map((x) => EmployeeRecompense.fromJson(x))),
        contract: json["contract"] == null
            ? null
            : Contract.fromJson(json["contract"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "employee_recompenses": employeeRecompenses == null
            ? []
            : List<dynamic>.from(employeeRecompenses!.map((x) => x.toJson())),
        "contract": contract?.toJson(),
      };
}
...
class EmployeeInfo {
  ...
  factory EmployeeInfo.fromJson(Map<String, dynamic> json) => EmployeeInfo(
        ...
        idIssueExpire: json["id_issue_expire"] == null
            ? null
            : DateTime.parse(json["id_issue_expire"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "id_issue_expire":
            "${idIssueExpire!.year.toString().padLeft(4, '0')}-${idIssueExpire!.month.toString().padLeft(2, '0')}-${idIssueExpire!.day.toString().padLeft(2, '0')}",
...
class EmployeeRecompense {
  ...
  factory EmployeeRecompense.fromJson(Map<String, dynamic> json) =>
      EmployeeRecompense(
        id: json["id"],
        enName: json["en_name"],
        arName: json["ar_name"],
